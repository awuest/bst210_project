...
# try spline 
fit_age_cubic_spline <- glm(formula = pap_num ~ bSpline(age, df = 6, degree = 3) + income_indiv + income_fam + totexp + outofpocket_exp + genhlth_avg_f + region_f + race_f + marital_stat_f + educ_f + smoke_freq_f + limitation_f + afford_care_f + have_usc_f + inscov_gen_2018_f, family = binomial(), data = train_set)
...
# try gam
fit_age_gam <- glm(formula = pap_num ~ s(age,4) + income_indiv + income_fam + totexp + outofpocket_exp + genhlth_avg_f + region_f + race_f + marital_stat_f + educ_f + smoke_freq_f + limitation_f + afford_care_f + have_usc_f + inscov_gen_2018_f, family = binomial(), data = train_set)
...
fit_ii_spline <- glm(formula = pap_num ~ age + I(age^2) + bSpline(income_indiv, df = 6, degree = 3) + income_fam + totexp + outofpocket_exp + genhlth_avg_f + region_f + race_f + marital_stat_f + educ_f + smoke_freq_f + limitation_f + afford_care_f + have_usc_f + inscov_gen_2018_f + marital_stat_f*income_fam + educ_f*totexp, family = binomial(), data = train_set)
...
# try gam
fit_ii_gam <- gam(formula = pap_num ~ age + I(age^2) + s(income_indiv, 4) + income_fam + totexp + outofpocket_exp + genhlth_avg_f + region_f + race_f + marital_stat_f + educ_f + smoke_freq_f + limitation_f + afford_care_f + have_usc_f + inscov_gen_2018_f + marital_stat_f*income_fam + educ_f*totexp, family = binomial(), data = train_set)
...
fit_ifam_spline <- glm(formula = pap_num ~ age + I(age^2) + income_indiv + bSpline(income_fam, df = 6, degree = 3) + totexp + outofpocket_exp + genhlth_avg_f + region_f + race_f + marital_stat_f + educ_f + smoke_freq_f + limitation_f + afford_care_f + have_usc_f + inscov_gen_2018_f + marital_stat_f*income_fam + educ_f*totexp, family = binomial(), data = train_set)
...
# try gam
fit_ifam_gam <- gam(formula = pap_num ~ age + I(age^2) + income_indiv + s(income_fam, 4) +  totexp + outofpocket_exp + genhlth_avg_f + region_f + race_f + marital_stat_f + educ_f + smoke_freq_f + limitation_f + afford_care_f + have_usc_f + inscov_gen_2018_f + marital_stat_f*income_fam + educ_f*totexp, family = binomial(), data = train_set)
...
fit_texp_spline <- glm(formula = pap_num ~ age + I(age^2) + income_indiv + income_fam + bSpline(totexp, df=6, degrees=3) + outofpocket_exp + genhlth_avg_f + region_f + race_f + marital_stat_f + educ_f + smoke_freq_f + limitation_f + afford_care_f + have_usc_f + inscov_gen_2018_f + marital_stat_f*income_fam + educ_f*totexp, family = binomial(), data = train_set)
...
# try gam
fit_texp_gam <- gam(formula = pap_num ~ age + I(age^2) + income_indiv + income_fam + s(totexp, 4) + outofpocket_exp + genhlth_avg_f + region_f + race_f + marital_stat_f + educ_f + smoke_freq_f + limitation_f + afford_care_f + have_usc_f + inscov_gen_2018_f + marital_stat_f*income_fam + educ_f*totexp, family = binomial(), data = train_set)
...
fit_oop_quad <- glm(formula = pap_num ~ age + I(age^2) + income_indiv + income_fam + bSpline(totexp, df=6, degrees=3) + outofpocket_exp + I(outofpocket_exp^2) + genhlth_avg_f + region_f + race_f + marital_stat_f + educ_f + smoke_freq_f + limitation_f + afford_care_f + have_usc_f + inscov_gen_2018_f + marital_stat_f*income_fam + educ_f*totexp, family = binomial(), data = train_set)
...
fit_oop_spline <- glm(formula = pap_num ~ age + I(age^2) + income_indiv + income_fam + bSpline(totexp, df=6, degrees =3) + bSpline(outofpocket_exp, df=6, degrees=3) + genhlth_avg_f + region_f + race_f + marital_stat_f + educ_f + smoke_freq_f + limitation_f + afford_care_f + have_usc_f + inscov_gen_2018_f + marital_stat_f*income_fam + educ_f*totexp, family = binomial(), data = train_set)
...
# spline total expense
fit_final <- glm(formula = pap_num ~ age + I(age^2) + income_indiv + income_fam + bSpline(totexp, df=6, degrees=3) + outofpocket_exp + genhlth_avg_f + region_f + race_f + marital_stat_f + educ_f + smoke_freq_f + limitation_f + afford_care_f + have_usc_f + inscov_gen_2018_f + marital_stat_f*income_fam + educ_f*totexp, family = binomial(), data = train_set)
kable(summary(fit_final)$coefficients)

# find p cutoff that balances specifity and sensitivity best 
p_seq <- seq(0, 1, .01)
sensitivity <- rep(NA, length(p_seq))
specificity <- rep(NA, length(p_seq))
for (i in 1:length(p_seq)) {
